...
export default class SapisStore {
  constructor() {
    ...
    reaction(() => this.data, data => console.log("New SAPIS data", this.data));
  ...
  analyzeText(data, stillettOptions) {
    ...
    SAPISRequest(data, function(data) { this.data = data; this.requesting = false; }.bind(this), stillettOptions);
  }
};
